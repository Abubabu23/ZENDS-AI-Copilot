...
INTENT_MODEL_PATH = "Abuthahirbabu/zends-intent-model"   # ✅ HF Hub
...
def load_intent_model():
    """Load intent classification model from HF Hub"""
...
def load_groq_client():
    """Load Groq client"""
    return Groq(api_key=st.secrets["GROQ_API_KEY"])   # ✅ Secrets
